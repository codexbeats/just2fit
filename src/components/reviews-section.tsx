...
export function ReviewsSection() {
  return (
    <section id="reviews" className="relative border-t border-white/5 bg-transparent  py-16 sm:py-32">
        ...
        <FadeUp>
          <div className="flex flex-col items-start gap-6 md:flex-row md:items-end md:justify-between">
            ...
            <div className="flex items-center gap-4 rounded-2xl border border-primary/30 bg-primary/5 px-5 py-4">
              <div>
                <div className="font-display text-4xl text-primary text-glow">5.0</div>
                <div className="text-xs uppercase tracking-wider text-muted-foreground">Google</div>
              </div>
              <div>
                ...
                <div className="mt-1 text-xs text-muted-foreground">61 verified reviews</div>
              </div>
            </div>
          </div>
        </FadeUp>
        ...
        <div className="mt-10 md:mt-12 grid gap-5 md:grid-cols-2">
          {REVIEWS.map((r, i) => (
            <FadeUp key={r.name + i} delay={i * 0.1}>
              <figure className="h-full rounded-2xl border border-white/8 bg-surface/60  p-7 transition-colors hover:border-primary/30">
