        ...
        <div className="mt-10 sm:mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-2">
          {FEATURES.map((f, i) => (
            <FadeUp key={f.title} delay={i * 0.1}>
              <div className="group h-full rounded-2xl border border-white/8 bg-surface/60  p-7 transition-all hover:-translate-y-1 hover:border-primary/40 hover:shadow-[var(--shadow-glow-sm)]">
